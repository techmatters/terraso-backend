...
from .projects import ProjectAddMutation, ProjectAddSiteMutation
...
class Mutations(graphene.ObjectType):
    ...
    project_add_mutation = ProjectAddMutation.Field()
    project_add_site_mutation = ProjectAddSiteMutation.Field()
